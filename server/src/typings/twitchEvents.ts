...
type ChannelPointsCustomRewardRedemptionEvent = {
...
export type EventFromSubscriptionType<T extends EventsubSubscriptionType> = T extends 'channel.channel_points_custom_reward_redemption.add'
  ...
  ? ChannelFollowEvent
  : T extends 'channel.subscribe'
  ? ChannelSubscribeEvent
  : T extends 'channel.subscription.gift'
  ? ChannelSubscriptionGiftEvent
  : T extends 'stream.online'
  ? StreamOnlineEvent
  : T extends 'stream.offline'
  ? StreamOfflineEvent
  : never;
