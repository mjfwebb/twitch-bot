...
import {
  DEFAULT_CHAT_SETTINGS_VALUES,
  PRESET_CHAT_SETTINGS_VALUES,
} from "../../constants";
...
export const ChatDashboard = () => {
  ...
  const [numberOfFakeMessagesPerSecond, setNumberOfFakeMessagesPerSecond] =
    useState<number>(0);
  const [sendFakeMessagesPerSecond, setSendFakeMessagesPerSecond] =
  ...
  const showColonAfterDisplayName = useChatSettingsStore(
    (s) => s.showColonAfterDisplayName,
  );
  ...
  if (backgroundColor !== DEFAULT_CHAT_SETTINGS_VALUES.backgroundColor) {
    chatURL.searchParams.append(
      chatSearchParamsMap.backgroundColor,
      backgroundColor,
    );
  }
  if (foregroundColor !== DEFAULT_CHAT_SETTINGS_VALUES.foregroundColor) {
    chatURL.searchParams.append(
      chatSearchParamsMap.foregroundColor,
      foregroundColor,
    );
  }
  ...
  if (showColonAfterDisplayName === true) {
    chatURL.searchParams.append(
      chatSearchParamsMap.showColonAfterDisplayName,
      "true",
    );
  }
  if (
  ...
  if (
    ...
    chatURL.searchParams.append(
      chatSearchParamsMap.secondsBeforeExit,
      String(secondsBeforeExit),
    );
  }
  ...
  if (
    ...
    chatURL.searchParams.append(
      chatSearchParamsMap.dropShadowSettings,
      dropShadowSettings,
    );
  }
  if (
    ...
    chatURL.searchParams.append(
      chatSearchParamsMap.textStrokeSettings,
      textStrokeSettings,
    );
  }
  if (
  ...
  const chatURLString = `${chatURL.protocol}${"//"}${chatURL.host}${
    chatURL.pathname
  }${chatURL.search}`;
  ...
  return (
    <div className="chat-dashboard">
      ...
      <h3>Link to copy:</h3>
      <p>
        <span className="chat-dashboard-note">Note</span>When you change
      ...
      <h3>Preview:</h3>
      <p>
        <span className="chat-dashboard-note">Note</span> This is a preview of
        what the chat will look like. It may not be 100% accurate, but it should
        be close. To get a better idea of what it will look like, you can copy
        the link above and open it in a new tab and send some test messages.
      </p>
      ...
      <div className="chat-modifiers">
          ...
          <button
            onClick={() =>
              useChatSettingsStore
                .getState()
                .setBackgroundColor(
                  DEFAULT_CHAT_SETTINGS_VALUES.backgroundColor,
                )
            }
          >
            reset
          ...
          <button
            onClick={() =>
              useChatSettingsStore
                .getState()
                .setForegroundColor(
                  DEFAULT_CHAT_SETTINGS_VALUES.foregroundColor,
                )
            }
          >
            reset
          ...
          <button
            onClick={() => {
              useChatSettingsStore
                .getState()
                .setFontSizeValue(
                  PRESET_CHAT_SETTINGS_VALUES.fontSizeValueSmall,
                );
              useChatSettingsStore
                .getState()
                .setFontSizeUnit(PRESET_CHAT_SETTINGS_VALUES.fontSizeUnit);
            }}
          >
            preset small
          </button>
          <button
            onClick={() => {
              useChatSettingsStore
                .getState()
                .setFontSizeValue(
                  PRESET_CHAT_SETTINGS_VALUES.fontSizeValueMedium,
                );
              useChatSettingsStore
                .getState()
                .setFontSizeUnit(PRESET_CHAT_SETTINGS_VALUES.fontSizeUnit);
          ...
          <button
            onClick={() => {
              useChatSettingsStore
                .getState()
                .setFontSizeValue(
                  PRESET_CHAT_SETTINGS_VALUES.fontSizeValueLarge,
                );
              useChatSettingsStore
                .getState()
                .setFontSizeUnit(PRESET_CHAT_SETTINGS_VALUES.fontSizeUnit);
        ...
        <div className="chat-modifiers-row chat-modifiers-label-above">
          ...
          <FontPicker
            ...
            value={fontFamily}
            onChange={(fontFamily) =>
              useChatSettingsStore.getState().setFontFamily(fontFamily)
            }
          />
          ...
          <button
            onClick={() =>
              useChatSettingsStore
                .getState()
                .setFontFamily(DEFAULT_CHAT_SETTINGS_VALUES.fontFamily)
            }
          >
            reset
          </button>
        ...
        <div className="chat-modifiers-row">
          <input
            ...
            onChange={(event) =>
              useChatSettingsStore
                .getState()
                .setDropShadowEnabled(event.target.checked)
            }
          />
          ...
          <div className="chat-modifiers-row chat-modifiers-label-above">
            ...
            <button
              onClick={() =>
                useChatSettingsStore
                  .getState()
                  .setDropShadowSettings(
                    PRESET_CHAT_SETTINGS_VALUES.dropShadowSettingsPresetSmall,
                  )
              }
            >
              preset small
            ...
            <button
              onClick={() =>
                useChatSettingsStore
                  .getState()
                  .setDropShadowSettings(
                    PRESET_CHAT_SETTINGS_VALUES.dropShadowSettingsPresetMedium,
                  )
              }
            >
              preset medium
            ...
            <button
              onClick={() =>
                useChatSettingsStore
                  .getState()
                  .setDropShadowSettings(
                    PRESET_CHAT_SETTINGS_VALUES.dropShadowSettingsPresetLarge,
                  )
              }
            >
              preset large
            ...
            <button
              ...
              onClick={() =>
                useChatSettingsStore
                  .getState()
                  .setDropShadowSettings(
                    DEFAULT_CHAT_SETTINGS_VALUES.dropShadowSettings,
                  )
              }
            >
        ...
        <div className="chat-modifiers-row">
          <input
            ...
            onChange={(event) =>
              useChatSettingsStore
                .getState()
                .setTextStrokeEnabled(event.target.checked)
            }
          />
          ...
          <div className="chat-modifiers-row">
            <input
              ...
              onChange={(event) =>
                useChatSettingsStore
                  .getState()
                  .setTextStrokeSettings(event.target.value)
              }
            />
              ...
              onClick={() =>
                useChatSettingsStore
                  ...
                  .setTextStrokeSettings(
                    PRESET_CHAT_SETTINGS_VALUES.textStrokeSettingsPresetThin,
                  )
              }
            >
              preset thin
            ...
            <button
              onClick={() =>
                useChatSettingsStore
                  .getState()
                  .setTextStrokeSettings(
                    PRESET_CHAT_SETTINGS_VALUES.textStrokeSettingsPresetMedium,
                  )
              }
            >
              preset medium
            ...
            <button
              onClick={() =>
                useChatSettingsStore
                  .getState()
                  .setTextStrokeSettings(
                    PRESET_CHAT_SETTINGS_VALUES.textStrokeSettingsPresetThick,
                  )
              }
            >
              preset thick
            ...
            <button
              ...
              onClick={() =>
                useChatSettingsStore
                  .getState()
                  .setTextStrokeSettings(
                    DEFAULT_CHAT_SETTINGS_VALUES.textStrokeSettings,
                  )
              }
            >
        ...
        <div className="chat-modifiers-row">
          <input
            ...
            onChange={(event) =>
              useChatSettingsStore
                .getState()
                .setAnimatedEntry(event.target.checked)
            }
          />
          <label htmlFor="chat_has_animated_entrance">
            Animate chat message entrance
          </label>
        </div>
        <div className="chat-modifiers-row">
          <input
        ...
        <div className="chat-modifiers-row">
          <input
            ...
            onChange={(event) =>
              useChatSettingsStore
                .getState()
                .setShowColonAfterDisplayName(event.target.checked)
            }
          />
          <label htmlFor="chat_has_colon_after_display_name">
            Show colon after username
          </label>
        </div>
        <div className="chat-modifiers-row">
          <input
            ...
            onChange={(event) =>
              useChatSettingsStore
                .getState()
                .setAnimatedExit(event.target.checked)
            }
          />
            ...
            <>
              ...
              <input
                ...
                onChange={(event) =>
                  useChatSettingsStore
                    .getState()
                    .setSecondsBeforeExit(Number(event.target.value))
                }
              />
              seconds
              <button
                onClick={() =>
                  useChatSettingsStore
                    .getState()
                    .setSecondsBeforeExit(
                      Number(DEFAULT_CHAT_SETTINGS_VALUES.secondsBeforeExit),
                    )
                }
              >
                reset
        ...
        <div>
          ...
          <div className="chat-modifiers-row">
            <input
              ...
              onChange={(event) =>
                setNumberOfFakeMessages(Number(event.target.value))
              }
            />
            <label htmlFor="chat_number_of_fake_messages">messages</label>
            <button
              onClick={() =>
                socket.sendToServer("getFakeChatMessages", numberOfFakeMessages)
              }
            >
              send
            </button>
          ...
          <div className="chat-modifiers-row">
            <input
              ...
              onChange={(event) =>
                setNumberOfFakeMessagesPerSecond(Number(event.target.value))
              }
            />
            <label htmlFor="chat_number_of_fake_messages_per_second">
              messages per second
            </label>
            <button
              onClick={() =>
                setSendFakeMessagesPerSecond(!sendFakeMessagesPerSecond)
              }
            >
