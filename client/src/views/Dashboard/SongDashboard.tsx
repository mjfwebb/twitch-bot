...
import {
  DEFAULT_SONG_SETTINGS_VALUES,
  PRESET_SONG_SETTINGS_VALUES,
} from "../../constants";
...
export const SongDashboard = () => {
  ...
  const titleDropShadowEnabled = useSongSettingsStore(
    (s) => s.titleDropShadowEnabled,
  );
  const titleDropShadowSettings = useSongSettingsStore(
    (s) => s.titleDropShadowSettings,
  );
  const titleTextStrokeEnabled = useSongSettingsStore(
    (s) => s.titleTextStrokeEnabled,
  );
  const titleTextStrokeSettings = useSongSettingsStore(
    (s) => s.titleTextStrokeSettings,
  );
  const artistsDropShadowEnabled = useSongSettingsStore(
    (s) => s.artistsDropShadowEnabled,
  );
  const artistsDropShadowSettings = useSongSettingsStore(
    (s) => s.artistsDropShadowSettings,
  );
  const artistsTextStrokeEnabled = useSongSettingsStore(
    (s) => s.artistsTextStrokeEnabled,
  );
  const artistsTextStrokeSettings = useSongSettingsStore(
    (s) => s.artistsTextStrokeSettings,
  );
  ...
  const artistsFontSizeValue = useSongSettingsStore(
    (s) => s.artistsFontSizeValue,
  );
  ...
  if (secondaryColor !== DEFAULT_SONG_SETTINGS_VALUES.secondaryColor) {
    songURL.searchParams.append(
      songSearchParamsMap.secondaryColor,
      secondaryColor,
    );
  }
  if (
  ...
  if (titleDropShadowEnabled) {
    songURL.searchParams.append(
      songSearchParamsMap.titleDropShadowEnabled,
      "true",
    );
  }
  if (
    ...
    songURL.searchParams.append(
      songSearchParamsMap.titleDropShadowSettings,
      titleDropShadowSettings,
    );
  }
  if (titleTextStrokeEnabled) {
    songURL.searchParams.append(
      songSearchParamsMap.titleTextStrokeEnabled,
      "true",
    );
  }
  if (
    ...
    songURL.searchParams.append(
      songSearchParamsMap.artistsTextStrokeSettings,
      artistsTextStrokeSettings,
    );
  }
  if (artistsDropShadowEnabled) {
    songURL.searchParams.append(
      songSearchParamsMap.artistsDropShadowEnabled,
      "true",
    );
  }
  if (
    ...
    songURL.searchParams.append(
      songSearchParamsMap.artistsDropShadowSettings,
      artistsDropShadowSettings,
    );
  }
  if (artistsTextStrokeEnabled) {
    songURL.searchParams.append(
      songSearchParamsMap.artistsTextStrokeEnabled,
      "true",
    );
  }
  if (
  ...
  if (
    ...
    songURL.searchParams.append(
      songSearchParamsMap.artistsFontSize,
      String(artistsFontSizeValue),
    );
  }
  if (artistsFontFamily !== DEFAULT_SONG_SETTINGS_VALUES.artistsFontFamily) {
    songURL.searchParams.append(
      songSearchParamsMap.artistsFontFamily,
      artistsFontFamily,
    );
  }
  if (!showAlbumArt) {
  ...
  const songURLString = `${songURL.protocol}${"//"}${songURL.host}${
    songURL.pathname
  }${songURL.search}`;
  ...
  return (
    <div className="song-dashboard">
      ...
      <h3>Link to copy:</h3>
      <p>
        <span className="song-dashboard-note">Note</span>When you change
        options, copy the new version of the link and update your browser
        source.
      </p>
      <div className="link">
      ...
      <h3>Preview:</h3>
      <p>
        <span className="song-dashboard-note">Note</span> Make sure you are
        playing a song.
      </p>
      ...
      <h3>Settings:</h3>
      <p>
        These settings will be saved on this same computer for the next time you
        visit this page.
      </p>
      <div className="song-modifiers">
        <div className="song-modifiers-row song-modifiers-label-above">
          ...
          <button
            onClick={() =>
              useSongSettingsStore
                .getState()
                .setPrimaryColor(DEFAULT_SONG_SETTINGS_VALUES.primaryColor)
            }
          >
            reset
          </button>
        ...
        <div className="song-modifiers-row song-modifiers-label-above">
          ...
          <button
            onClick={() =>
              useSongSettingsStore
                .getState()
                .setSecondaryColor(DEFAULT_SONG_SETTINGS_VALUES.secondaryColor)
            }
          >
            reset
          </button>
        ...
        <div className="song-modifiers-row song-modifiers-label-above">
          ...
          <input
            ...
            onChange={(e) =>
              useSongSettingsStore
                .getState()
                .setTitleFontSizeValue(+e.target.value)
            }
          />
          <button
            onClick={() => {
              useSongSettingsStore
                .getState()
                .setTitleFontSizeValue(
                  PRESET_SONG_SETTINGS_VALUES.titleFontSizeValueSmall,
                );
            }}
          >
            preset small
          ...
          <button
            onClick={() => {
              useSongSettingsStore
                .getState()
                .setTitleFontSizeValue(
                  PRESET_SONG_SETTINGS_VALUES.titleFontSizeValueMedium,
                );
            }}
          >
            preset medium
          ...
          <button
            onClick={() => {
              useSongSettingsStore
                .getState()
                .setTitleFontSizeValue(
                  PRESET_SONG_SETTINGS_VALUES.titleFontSizeValueLarge,
                );
            }}
          >
            preset large
        ...
        <div className="song-modifiers-row song-modifiers-label-above">
          ...
          <FontPicker
            ...
            onChange={(fontFamily) =>
              useSongSettingsStore.getState().setTitleFontFamily(fontFamily)
            }
          />
        ...
        <div className="song-modifiers-row song-modifiers-label-above">
          ...
          <input
            ...
            onChange={(e) =>
              useSongSettingsStore
                .getState()
                .setArtistsFontSizeValue(+e.target.value)
            }
          />
          <button
            onClick={() => {
              useSongSettingsStore
                .getState()
                .setArtistsFontSizeValue(
                  PRESET_SONG_SETTINGS_VALUES.artistsFontSizeValueSmall,
                );
            }}
          >
            preset small
          ...
          <button
            onClick={() => {
              useSongSettingsStore
                .getState()
                .setArtistsFontSizeValue(
                  PRESET_SONG_SETTINGS_VALUES.artistsFontSizeValueMedium,
                );
            }}
          >
            preset medium
          ...
          <button
            onClick={() => {
              useSongSettingsStore
                .getState()
                .setArtistsFontSizeValue(
                  PRESET_SONG_SETTINGS_VALUES.artistsFontSizeValueLarge,
                );
            }}
          >
            preset large
        ...
        <div className="song-modifiers-row song-modifiers-label-above">
          ...
          <FontPicker
            ...
            onChange={(fontFamily) =>
              useSongSettingsStore.getState().setArtistsFontFamily(fontFamily)
            }
          />
        ...
        <div className="song-modifiers-row">
          <input
            ...
            onChange={(event) =>
              useSongSettingsStore
                .getState()
                .setShowAlbumArt(event.target.checked)
            }
          />
        ...
        <div className="song-modifiers-row">
          <input
            ...
            onChange={(event) =>
              useSongSettingsStore
                .getState()
                .setTitleDropShadowEnabled(event.target.checked)
            }
          />
          <label htmlFor="song_title_has_drop_shadow">
            Title text has drop shadow
          </label>
        </div>
        {titleDropShadowEnabled && (
          <div className="song-modifiers-row song-modifiers-label-above">
            <label htmlFor="song_title_drop_shadow">
              Title text drop shadow settings
            </label>
            <TextShadowPicker
              ...
              onChange={(value) => {
                useSongSettingsStore
                  .getState()
                  .setTitleDropShadowSettings(value);
              }}
            />
            <button
              onClick={() =>
                useSongSettingsStore
                  .getState()
                  .setTitleDropShadowSettings(
                    PRESET_SONG_SETTINGS_VALUES.dropShadowSettingsPresetSmall,
                  )
              }
            >
              preset small
            ...
            <button
              onClick={() =>
                useSongSettingsStore
                  .getState()
                  .setTitleDropShadowSettings(
                    PRESET_SONG_SETTINGS_VALUES.dropShadowSettingsPresetMedium,
                  )
              }
            >
              preset medium
            ...
            <button
              onClick={() =>
                useSongSettingsStore
                  .getState()
                  .setTitleDropShadowSettings(
                    PRESET_SONG_SETTINGS_VALUES.dropShadowSettingsPresetLarge,
                  )
              }
            >
              preset large
        ...
        <div className="song-modifiers-row">
          <input
            ...
            onChange={(event) =>
              useSongSettingsStore
                .getState()
                .setTitleTextStrokeEnabled(event.target.checked)
            }
          />
          <label htmlFor="song_title_has_text_stroke">
          ...
          <div className="song-modifiers-row">
            <input
              ...
              onChange={(event) =>
                useSongSettingsStore
                  .getState()
                  .setTitleTextStrokeSettings(event.target.value)
              }
            />
            ...
            <button
              onClick={() =>
                useSongSettingsStore
                  .getState()
                  .setTitleTextStrokeSettings(
                    PRESET_SONG_SETTINGS_VALUES.textStrokeSettingsPresetThin,
                  )
              }
            >
              preset thin
            ...
            <button
              onClick={() =>
                useSongSettingsStore
                  .getState()
                  .setTitleTextStrokeSettings(
                    PRESET_SONG_SETTINGS_VALUES.textStrokeSettingsPresetMedium,
                  )
              }
            >
              preset medium
            ...
            <button
              onClick={() =>
                useSongSettingsStore
                  .getState()
                  .setTitleTextStrokeSettings(
                    PRESET_SONG_SETTINGS_VALUES.textStrokeSettingsPresetThick,
                  )
              }
            >
              preset thick
        ...
        <div className="song-modifiers-row">
          <input
            ...
            onChange={(event) =>
              useSongSettingsStore
                .getState()
                .setArtistsDropShadowEnabled(event.target.checked)
            }
          />
          <label htmlFor="song_artists_has_drop_shadow">
            Artists text has drop shadow
          </label>
        </div>
        {artistsDropShadowEnabled && (
          <div className="song-modifiers-row song-modifiers-label-above">
            <label htmlFor="song_artists_drop_shadow">
              Artists text drop shadow settings
            </label>
            <TextShadowPicker
              ...
              onChange={(value) => {
                useSongSettingsStore
                  .getState()
                  .setArtistsDropShadowSettings(value);
              }}
            />
            <button
              onClick={() =>
        ...
        <div className="song-modifiers-row">
          <input
            ...
            onChange={(event) =>
              useSongSettingsStore
                .getState()
                .setArtistsTextStrokeEnabled(event.target.checked)
            }
          />
          <label htmlFor="song_artists_has_text_stroke">
            Artists text has stroke
          </label>
        </div>
        {artistsTextStrokeEnabled && (
          <div className="song-modifiers-row">
            <input
              ...
              onChange={(event) =>
                useSongSettingsStore
                  .getState()
                  .setArtistsTextStrokeSettings(event.target.value)
              }
            />
            <label htmlFor="song_artists_text_stroke">
